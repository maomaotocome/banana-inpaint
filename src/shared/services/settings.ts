...
export async function getSettings() {
  ...
  "premium-yearly": "prod_xxx"
    ...
    },
    {
      ...
      type: 'url',
      placeholder: 'https://api.aicodewith.com/v1',
      tip: 'Set any OpenAI compatible API URL, leave empty to use the default OpenRouter API URL. For AI Code With users: Use https://api.aicodewith.com/v1 (recommended, overseas direct connection) or https://api.jiuwanliguoxue.com/v1 (backup, domestic route)',
      group: 'openrouter',
      tab: 'ai',
    },
    {
